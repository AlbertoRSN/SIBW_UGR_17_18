...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2018 a las 13:45:04
...
CREATE TABLE `comentarios` (
  ...
  `Fecha-Hora` varchar(20) NOT NULL,
...
INSERT INTO `comentarios` (`IP`, `Nombre`, `Correo`, `Fecha-Hora`, `Comentario`) VALUES
...
INSERT INTO `ususarios` (`Contraseña`, `Correo`, `Usuario`) VALUES
('contrasenia1', 'correo1@gmail.com', 'Marta'),
('contrasenia2', 'correo2@gmail.com', 'Adriana');
