   		...
   		<!--obra.html-->
		<section id="contenido-principal-obra">
			...
			<div id="Fotos_obra">
				...
				<img id="imagen_obra1" src="imgs/Fiat_clasico.jpg" >Fiat clásico</img>
				<p></p>
				<img id="imagen_obra2" src="imgs/Fiat_500.jpg" >Fiat 500</img>
			...
			<section class="Parte1">
				...
				<p>El Fiat 500, es un automóvil fabricado por la empresa italiana Fiat entre los años 1957 y 1975.
			...
			<section class="Parte1">
				...
				El mismo Fessia confía el encargo a Dante Giacosa, un joven ingeniero que era por ese entonces su asistente en la proyección del Balilla, considerándolo el hombre justo para realizar aquello que la dirección de la empresa esperaba.</p>	

			</section>


			<div id="social">
				<a id="fc" href="https://es-es.facebook.com/"><img id=tw src="imgs/fc.png"></a>	
				<a id="tw" href="https://twitter.com/"><img id=tw src="imgs/tw.png"></a>
				<a id="impresora" href="imprimir.html"><img id=tw src="imgs/impresora.png"></a>
			</div>
	
		</section>

		<!-- Comentarios menu derecho -->
			<aside id="columna-derecha">

				<button type="button"onclick="Comentarios()">Comentarios</button>   <!--  Comentarios() es una funcion de javascript.js  -->
				...
				<div id="formularios">
				 	...
				 	<div id="comentarios">
						...
						<div class="comentario">
							...
							<div class="texto_comentario">
								<p>Es interesante, siempre creí que este coche era egipcio.</p>
							</div>
					...
					<div id="OpcionesFormulario">
						<form id="formulario" name="formulario" action="#" onsubmit="return validateForm()" method="post">
							<p>Nombre: <input class="text-box" type="text" name="fname"> </p>
							<p>E-mail: <input type="text" name="fcorreo"> </p>
							<p>Texto del comentario: <input type="text" name="fcomentario" onkeypress="PalabrasProhibidas(this)"> </p>
					 	</form>
						<button id="Enviar" onclick="Comentar()">Enviar</button>
					</div> 
				</div>
